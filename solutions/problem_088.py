...
# Slow-ish (10s)
def compute():
	def get_multisets(max_sum, max_prod, max_elt, num_elts):  # Returns list of sorted tuples that fit constraints, numbers must be ints > 0
	...
	a =  sum(set(sols.values()))  # Sum the unique values
	return a, 'Sum of minimal product-sum number for 2<=k<=12000'
